...
public class OfflineExercisesTest {
	...
	public void amISearchTest() {
		...
		assertEquals(1, oe.amISearch(" am"));
		assertEquals(1, oe.amISearch("aaaaaaaaaaaaaaaaaaa am"));
		assertEquals(1, oe.amISearch("am"));
		assertEquals(0, oe.amISearch("aa"));
		assertEquals(0, oe.amISearch("amb I in Amsterdam?"));
